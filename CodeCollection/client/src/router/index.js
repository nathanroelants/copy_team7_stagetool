...
const routes = [
  ...
  { path: '/stagementorlogboeken', component: () => import('../views/stagementor/StagementorLogboeken.vue') },
  { path: '/stagementor/evaluatie', component: () => import('../views/stagementor/StagementorEvaluatieView.vue') },
